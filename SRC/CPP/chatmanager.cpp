 ...
 * @brief ChatManager::SendGroupChat
 * @param msg
 */
...
/**
 * * Fetch user to user chat history and display using query(group).
 * @brief ChatManager::DisplayGroupChat
 */
 ...
 * @brief ChatManager::on_SetupChatConnection
 * @param name
 * @param details
 */
 ...
 * @brief ChatManager::on_SetupGroupChatConnection
 * @param name
 * @param details
 */
...
/**
 * Details fetcher from server and fill the reciever details.
 * @brief ChatManager::x_fetchRecieverDetails
 */
...
/**
 * Details fetcher from server and fill the reciever details(group).
 * @brief ChatManager::x_fetchGroupRecieverDetails
 */
